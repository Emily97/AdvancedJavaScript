...
⸨░░░░░░░░░░⠂⠂⠂⠂⠂⠂⠂⠂⸩ ⠹ loadExtraneous: verb afterAdd /Users/rebecca/.npm/null/0.0.0/package/package.json written
 ↑‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾  ↑ ‾‾‾‾‾‾‾‾‾↑‾‾‾‾   ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾↑‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾
 percent complete     LoadingIcon    current thing we're doing     most recent log line
```

The _LoadingIcon_ is intended as an activity indicator–it moves whenever
...
* `brailleLoadingIcon` – A braille based LoadingIcon and other unicode enhancements. MacOS only.
* `colorBrailleLoadingIcon` – The default on MacOS, a combination of the above two.
...
* [#6911](https://github.com/npm/npm/issues/6911)
  ...
  The LoadingIcon is gone (yay? boo? will you miss it?), and in its place npm
