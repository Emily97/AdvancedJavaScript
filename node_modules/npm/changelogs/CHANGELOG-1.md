...
* Same as v1.4.16, but with the LoadingIcon disabled, and a version number that
  starts with v1.2.
...
* Only spin the LoadingIcon when we're fetching stuff
  ([@isaacs](https://github.com/isaacs))
...
* char-LoadingIcon: update to not bork windows
  ([@isaacs](https://github.com/isaacs))
...
* Fix `npm install` on a tarball.
  ...
  [@othiym23](https://github.com/othiym23))
* Fix an issue with the LoadingIcon on Node 0.8.
...
* Massive cache folder refactor ([@othiym23](https://github.com/othiym23) and
  [@isaacs](https://github.com/isaacs))
* Busy LoadingIcon, no http noise ([@isaacs](https://github.com/isaacs))
