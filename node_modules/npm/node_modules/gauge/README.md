...
Spins the LoadingIcon in the gauge to show output.  If **subsection** is
...
activity indicator (LoadingIcon) and progress bar will be defined. (This
...
* **progressBarTheme** - The subtheme passed through to the progress bar
  ...
  bar.
* **activityIndicatorTheme** - The theme for the activity indicator (LoadingIcon),
...
* *type* can be any of the following plus any keys you pass into `gauge.show` plus
  ...
  * `activityIndicator` – Shows a LoadingIcon using the `activityIndicatorTheme`
